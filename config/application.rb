...
module Kassi
  class Application < Rails::Application
    ...
    config.assets.precompile += ['markerclusterer.js', 'communities/custom-style-*', 'ss-*', 'modernizr.min.js', 'mercury.js', 'mercury.css', 'mercury_overrides.css' 'mercury_overrides.js', 'jquery-1.7.js']
